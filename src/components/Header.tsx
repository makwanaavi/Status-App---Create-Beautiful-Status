          ...
          <div className="w-full sm:flex-1 max-w-full sm:max-w-md mx-0 sm:mx-8 mb-2 sm:mb-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-gray-50 text-sm sm:text-base"
              />
            </div>
          </div>
